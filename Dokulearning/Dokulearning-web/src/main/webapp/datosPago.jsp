						...
						<form onSubmit="return validacionDatosPago(this)"
							...
							<div class="form-group col-lg-4">
								...
								<label id="lblnombreCurso" for="nombreCurso">Nombre del
									...
									<label id="txtVale" for="vale">Vale
									de descuento</label><input type="text" placeholder="Ej.: VALEyyyymmddhhssSSSSXXZZ"
							...
							<div class="form-group col-lg-12">
								...
								<div class="form-group col-lg-12"
									...
									<input id="atras" style="margin-right:25px" type="button" class="btn btn-default"
										value="Atras" /> 
										
										<input id="btnEnviarPago" type="submit"
										class="btn btn-default" value="Confirmar compra" />
								</div>
							</div>
						</form>
					</div>
